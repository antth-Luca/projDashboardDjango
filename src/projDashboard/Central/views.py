...
class DashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # -> (%) de clientes que voltam comprar em 3 meses  #TODO: Adicionar restrição de "comprou 2 ou mais vezes dentro de 3 meses"
        ...
        # -> (%) de clientes que se cadastraram e compraram no mesmo mês num período de três meses atrás  #TODO: Trocar "mês atual" por "mês do cadastro do cliente" na hora de recuperar as compras dos clientes
